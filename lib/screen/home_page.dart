      ...
      appBar: AppBar(
        ...
        title: Row(
          ...
          children: [
            ...
            Text("Bangladesh Times", style: TextStyle(color: newsProvider.gr==Color(0xff2A2A36)?Colors.white:Colors.black),),
      ...
      body: Container(
        ...
        child: Column(
          children: [
                  ...
                  itemBuilder: (context, index) => Padding(
                    ...
                    child: Container(
                        child: TextButton(onPressed: ()async{
                          ...
                          setState(() {
                            print("tttttttttttttttttttttttttttttttttttttttttttttt${newstopic[index]}");
                          });
                            }, child:Text("${newstopic[index]}", style: TextStyle(fontSize: 20,fontWeight:
                        FontWeight.w700,color: newsProvider.gr==Color(0xff2A2A36)?Colors.white:Colors.black.withOpacity(.6)),),)
                    ),
                  )),
            ),),
                ...
                children: [
                  ...
                  Expanded(flex: 3,child:Row(
                    ...
                    children: [
                      ...
                      }, icon: Icon(Icons.light_mode_outlined,color: newsProvider.gr==Color(0xff2A2A36)?Colors.white:Colors.black)),
                      IconButton(onPressed: () {
                        newsProvider.color1();
                        setState(() {
                          print("cccccccccccccccccccccccccccccccccccccccccccccccccccccccc ${newsProvider.gr}");
                        });
                      }, icon: Icon(Icons.nightlight_outlined,color: newsProvider.gr==Color(0xff2A2A36)?Colors.white:Colors.black))
                    ],)
            ...
            Expanded(flex: 22, child: FutureBuilder<NewsModel>(
